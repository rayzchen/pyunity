 ...
 */
      /*else:*/ {
        ...
        {
          PyObject *__pyx_callargs[3] = {__pyx_t_6, __pyx_t_7, __pyx_kp_u_Shutting_PyUnity_down};
 ...
 */
        ...
        {
          PyObject *__pyx_callargs[3] = {__pyx_t_8, __pyx_t_15, __pyx_kp_u_Stopping_main_loop};
 ...
 */
          ...
          {
            PyObject *__pyx_callargs[3] = {__pyx_t_15, __pyx_t_8, __pyx_kp_u_Shutting_PyUnity_down};
            __pyx_t_6 = __Pyx_PyObject_FastCall(__pyx_t_14, __pyx_callargs+1-__pyx_t_10, 2+__pyx_t_10);
            __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
            __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[25], &__pyx_n_s_Scene) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[26], &__pyx_kp_u_SceneManager_already_contains_sc) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[27], &__pyx_kp_u_Scene_s_is_not_part_of_the_Scene) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[28], &__pyx_kp_u_Shutting_PyUnity_down) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[29], &__pyx_n_s_Start) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[30], &__pyx_kp_u_Stopping_main_loop) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[31], &__pyx_kp_u_The_provided_Scene_s_is_not_an_i) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[32], &__pyx_kp_u_The_provided_scene_is_not_of_typ) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[33], &__pyx_kp_u_The_provided_scene_is_not_part_o) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[34], &__pyx_kp_u_There_is_no_scene_at_index) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[35], &__pyx_kp_u_There_is_no_scene_at_index_d) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[36], &__pyx_kp_u_There_is_no_scene_called) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
